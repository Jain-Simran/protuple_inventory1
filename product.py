...
# rom pkg_resources import EntryPoint
...
class productClass:
    def __init__(self, root):
        ...
        # =======================Title=========================
        title = Label(product_Frame, text="Product Detalis", font=("goudy old style", 18), bg="#0f4d7d",
        ...
        txt_qty = Entry(product_Frame, textvariable=self.var_quantity, font=("goudy old style", 15),
        ...
        # =======================Buttons=================
        btn_add = Button(product_Frame, text="Save", command=self.add, font=("goudy old style", 15), bg="blue",
        ...
        btn_clear = Button(product_Frame, text="Clear", command=self.clear, font=("goudy old style", 15), bg="#607d8b",
                           fg="white", cursor="hand2").place(x=340, y=400, width=100, height=40)
