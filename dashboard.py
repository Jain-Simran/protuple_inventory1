...
class IMS:
    def __init__(self, root):
        ...
        # ===========LeftMenu=========================
        self.MenuLogo = PhotoImage(file="C:\\Users\\simran\\Downloads\\menu3.png")

        LeftMenu = Frame(self.root, bd=2, relief=RIDGE, bg="white")
        LeftMenu.place(x=0, y=102, width=200, height=469)
        lbl_menuLogo = Label(LeftMenu, image=self.MenuLogo)
        lbl_menuLogo.pack(side=TOP, fill=X)
        self.icon_side = PhotoImage(file="C:\\Users\\simran\\Downloads\\side.png")
        ...
        btn_sales = Button(LeftMenu, text="Sales", command=self.sales, image=self.icon_side, compound=LEFT, padx=5,
                           anchor="w", font=("times new roman", 20, "bold"), bg="white", bd=3, cursor="hand2").pack(
            side=TOP, fill=X)
        ...
        # ===============footer=======================================
        lbl_footer = Label(self.root, text="IMS - Inventory Management System ", font=("times new roman", 15),
                           bg="#4d636d", fg="white")
