...
class salesClass:
    ...
    def __init__(self, root):
        ...
        # ==============================Title==================================
        lbl_title = Label(self.root, text="View Customer Bill", font=("goudy old style", 30), bg="#184a45", fg="white",
        ...
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=("times new roman", 15, "bold"), bg="grey",
