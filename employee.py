...
class employeeClass:
    ...
    def __init__(self, root):
        ...
        # ============title===========
        title = Label(self.root, text="Employee Detalis", font=("goudy old style", 13), bg="#0f4d7d", fg="white").place(
            x=50, y=100, width=1000)

        # ============Content==============
        # ===row1===
        lbl_empid = Label(self.root, text="Emp ID", font=("goudy old style", 15), bg="white", cursor="hand2").place(
            x=50, y=150)
        lbl_gender = Label(self.root, text="Gender", font=("goudy old style", 15), bg="white", cursor="hand2").place(
            x=350, y=150)
        lbl_contact = Label(self.root, text="Contact", font=("goudy old style", 15), bg="white", cursor="hand2").place(
            x=750, y=150)

        txt_empid = Entry(self.root, textvariable=self.var_emp_id, font=("goudy old style", 15), bg="lightyellow",
                          cursor="hand2").place(x=150, y=150, width=180)
        ...
        lbl_name = Label(self.root, text="Name", font=("goudy old style", 15), bg="white", cursor="hand2").place(x=50,
                                                                                                                 y=190)
        lbl_dob = Label(self.root, text="D.O.B", font=("goudy old style", 15), bg="white", cursor="hand2").place(x=350,
                                                                                                                 y=190)
        lbl_doj = Label(self.root, text="D.O.J", font=("goudy old style", 15), bg="white", cursor="hand2").place(x=750,
                                                                                                                 y=190)
        ...
        # =====button====
        btn_add = Button(self.root, text="Save", command=self.add, font=("goudy old style", 15), bg="blue", fg="white",
