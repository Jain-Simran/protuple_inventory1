...
class Login:
    def __init__(self, root):
        ...
        # ==========Images====================
        self.log_img = Image.open("C:\\Users\\simran\\Downloads\\log.png")
        ...
        title = Label(login_frame, text="Login System", font=("Elephant", 30, "bold"), bg="white").place(x=0, y=30,
                                                                                                         relwidth=1)
        lbl_user = Label(login_frame, text="Eployee ID", font=("Andalus", 15), bg="white", fg="#767171").place(x=50,
                                                                                                               y=100)
            ...
            if self.employee_id.get() == "":
                ...
                if email == None:
                    ...
                    if chk == 'f':
                        ...
                        lbl_newpass = Label(self.forget_win, text="New Password", font=("times new roman", 15)).place(
                            x=20, y=160)
                        txt_newpass = Entry(self.forget_win, textvariable=self.var_newpass,
                        ...
                        txt_c_pass = Entry(self.forget_win, textvariable=self.var_con_pass,
