...
class Login_system:
    def __init__(self, root):
        ...
        txt_employee_id = Entry(login_frame, textvariable=self.employee_id, font=("times new roman", 15),
                                bg="lightgrey").place(x=50, y=140, width=250)

        lbl_pass = Label(login_frame, text="Paswword", font=("Andalus", 15), bg="white", fg="#767171").place(x=50,
                                                                                                             y=200)
        txt_pass = Entry(login_frame, textvariable=self.password, show="*", font=("times new roman", 15),
                         bg="lightgrey").place(x=50, y=240, width=250)

        btnlogin = Button(login_frame, command=self.login, text="Log In", font=("Arial Rounded MT Bold", 15),
                          bg="#00B0F0", cursor="hand2").place(x=50, y=300, width=250, height=35)
        ...
        btn_forget = Button(login_frame, text="Forget Password?", command=self.forget_window,
                            font=("times new roman", 13), bg="white", fg="#00759e", bd=0, activebackground="white",
                            activeforeground="#00759e").place(x=100, y=390)

        # ======Animation Frame=====
        self.img = ImageTk.PhotoImage(file="C:\\Users\\simran\\Downloads\\img.png")
        self.img1 = ImageTk.PhotoImage(file="C:\\Users\\simran\\Downloads\\img1.png")
        self.img2 = ImageTk.PhotoImage(file="C:\\Users\\simran\\Downloads\\img2.png")
    ...
    def animate(self):
        ...
        lbl_reg = Label(register_frame, text="Subscribe | Like | Share", font=("times new roman", 13),
            ...
            if self.employee_id.get() == "":
                ...
                if email == None:
                    ...
                    if chk == 'f':
                        ...
                        lbl_reset = Label(self.forget_win, text="Enter OTP sent on Registred Email",
                        ...
                        txt_c_pass = Entry(self.forget_win, textvariable=self.var_conf_pass,
                                           font=("times new roman", 15), bg="lightyellow").place(x=20, y=260, width=250,
                                                                                                 height=30)
                        self.btn_update = Button(self.forget_win, text="Update", command=self.update_password,
                                                 state=DISABLED, font=("times new roman", 15), bg="lightgreen")
